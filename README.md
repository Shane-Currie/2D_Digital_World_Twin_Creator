...
| [`v1.3`](v1.3/) | Completed release | Run `v1.2/Start Creator Studio.cmd` |
...
Active development continues locally in v1.3. It will be added as another version folder when that release is ready.
