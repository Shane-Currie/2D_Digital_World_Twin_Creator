...
func _build_shell() -> void:
	...
	title_group.add_child(_label("v1.3 · No-code digital-world development", 13, MUTED))
...
func _show_welcome_page() -> void:
	...
	var note := _notice_panel(
		"v1.3 foundation",
		"v1.3 builds on the completed v1.2 town workflow while adding the next map-independent gameplay and editing stages.",
		ACCENT
	)
